...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                 stretch_corners_arc))
    ((ConfigOptionFloatOrPercent,       stretch_corners_deviation_concave))
    ((ConfigOptionFloatOrPercent,       stretch_corners_deviation_convex))
    ((ConfigOptionFloatOrPercent,       stretch_corners_deviation_first_layer))
    ...
    ((ConfigOptionPercent,              print_bridge_fan_speed))
    ((ConfigOptionPercent,              print_fan_speed))
    ((ConfigOptionPercent,              print_perimeters_fan_speed))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloats,              filament_compressibility_factor))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionInts,                 enable_fan_first_layers))
    ((ConfigOptionBool,                 enforce_retract_first_layer))
    ((ConfigOptionBool,                 enforce_retract_top_surface))
    ...
    ((ConfigOptionInts,                 fan_speed_layer_gradient))
