    ...
    const ConfigOptionResolver &old_config, const ConfigOptionResolver &new_config, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    for (const t_config_option_key& opt_key : opt_keys) {
        if (
            ...
            || opt_key == "fill_gridvarspeed_width_diff"
            || opt_key == "fill_gridvarspeed_zhop"
            ...
            //}
                ...
                || opt_key == "print_bridge_fan_speed"
                || opt_key == "print_fan_speed"
                ...
                || opt_key == "stretch_corners_deviation_concave"
                || opt_key == "stretch_corners_deviation_convex"
                || opt_key == "stretch_corners_deviation_first_layer"
                ...
                || opt_key == "stretch_corners_inner_perimeters"
