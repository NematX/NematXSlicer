...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig* config)
{
    ...
    for (auto el : {"stretch_corners_arc", "stretch_corners_max_angle",
        ...
        "stretch_corners_entering_section", "stretch_corners_exiting_section",
    ...
    for (auto el : { "wipe_tower_x", "wipe_tower_y", "wipe_tower_width", "wipe_tower_rotation_angle", "wipe_tower_brim_width",
                     "wipe_tower_cone_angle", "wipe_tower_extra_spacing", "wipe_tower_separate_filament",
                     "wipe_tower_only_solid", "wipe_tower_perimeters", "wipe_tower_bridging", "wipe_tower_brim", "wipe_tower_no_sparse_layers", "single_extruder_multi_material_priming",
