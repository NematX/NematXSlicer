...
public:
    ...
    void            calibration_html_dialog();
    void            calibration_bed_leveling_dialog();
    void            calibration_flow_ratio_dialog();
    void            calibration_flow_speed_dialog();
    void            calibration_filament_temperature_dialog();
    void            calibration_bridge_tuning_dialog();
    void            calibration_over_bridge_dialog();
    void            calibration_pressure_dialog();
    void            calibration_cube_dialog();
    void            calibration_retraction_dialog();
    void            calibration_pressureadv_dialog();
    void            calibration_extruder_offset_dialog();
