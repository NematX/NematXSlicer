...
public:
    ...
    // FFF printer
    void    update_printer_fff_config(DynamicPrintConfig* config, uint16_t current_extruder_idx, const bool is_global_config = false);
    void    toggle_printer_fff_options(DynamicPrintConfig* config, const DynamicPrintConfig &full_config, uint16_t current_extruder_idx);
